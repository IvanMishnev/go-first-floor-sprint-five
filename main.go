...
func (r Running) Calories() float64 {
	// вставьте ваш код ниже
	c := (CaloriesMeanSpeedMultiplier*r.meanSpeed() + CaloriesMeanSpeedShift) * r.Weight / MInKm * r.Duration.Hours() * MinInHours
	return c
}
...
func (w Walking) Calories() float64 {
	// вставьте ваш код ниже
	c := (CaloriesWeightMultiplier*w.Weight + (math.Pow(w.meanSpeed()*KmHInMsec, 2)/w.Height)*CaloriesSpeedHeightMultiplier*w.Weight) * w.Duration.Hours() * MinInHours
	return c
}
...
func (s Swimming) meanSpeed() float64 {
	// вставьте ваш код ниже
	speed := float64(s.LengthPool) * float64(s.CountPool) / MInKm / float64(s.Duration.Hours())
	return speed
}
...
func (s Swimming) Calories() float64 {
	// вставьте ваш код ниже
	c := (s.meanSpeed() + SwimmingCaloriesMeanSpeedShift) * SwimmingCaloriesWeightMultiplier * s.Weight * s.Duration.Hours()
	return c
}
